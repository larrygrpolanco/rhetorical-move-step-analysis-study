...
def main():
    ...
    for split_name in ["validation", "test", "train"]:
        ...
        print(
            f"{split_name.capitalize():12} {len(split_articles):2} articles, {total_sentences:4} sentences"
        )
    ...
    with open(summary_path, "w", encoding="utf-8") as f:
        json.dump(
            {"total_articles": len(all_results), "articles": all_results},
            f,
            indent=2,
            ensure_ascii=False,
        )
